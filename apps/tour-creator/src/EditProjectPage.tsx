            ...
            <main className={styles.content}>
                <div className={styles.header}>
                    ...
                    <p className={styles.pageSubtitle}>
                        Welcome to the Tour Project Editor. Here you can upload your 360 images, place hotspots, and customize the presentation of your tour. 
                        Use the options on the right to manage different sections of your tour, and don't forget to save and publish when you're ready to share it with the world!
                    </p>
                    <p className={styles.pageSubtitle}>
                        Important information: Changes you make to a published tour will not be visible to the public until you unpublish and republish the tour again.
                        This allows you to work on updates without affecting the live version of your tour.
                    </p>                    
                </div>
